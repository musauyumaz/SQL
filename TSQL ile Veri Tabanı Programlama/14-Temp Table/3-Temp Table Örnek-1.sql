...
CREATE TABLE #RESULT (ID INT, ITEMCODE VARCHAR(100),ITEMNAME VARCHAR(100),TOTALSALE_M FLOAT,TOTALSALE_W FLOAT,RATIO FLOAT)
ALTER TABLE #RESULT ADD RATIO FLOAT
